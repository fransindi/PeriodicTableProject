...
--
-- Name: elements na_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT na_unique UNIQUE (name);
...
--
-- Name: elements sy_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT sy_unique UNIQUE (symbol);
